...
const Login: React.FC = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    setLoading(true);
    try {
      // In a real app, you'd use a Google Auth library here
      // For now, we'll simulate the process in Dev Mode
      if (import.meta.env.DEV || true) {
        await googleLogin({
          googleId: 'dev-google-id',
          email: 'google.dev@neuraltrack.org',
          ...
          <div className="space-y-6 pt-2">
            ...
            <div className="flex flex-col items-center gap-4">
              <button
                ...
                className="text-[9px] font-black text-[#A19F9D] uppercase tracking-[0.25em] hover:text-[#323130] transition-colors flex items-center gap-2"
              >
                <Shield size={10} />
                Dev Bypass
              </button>
